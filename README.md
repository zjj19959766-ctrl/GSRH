...
The following figure visualizes the geometric prior and semantic prior generated by GSRH on AI-TOD. These priors show how GPS and SRC guide geometry-aware feature selection and reliability-aware message regulation.

![Visualization of geometric and semantic priors](Fig/fig.prior.png)

### Ablation Visualization

The following figure shows the visual ablation of GPS and SRC on VEDAI, USOD, and AI-TOD. It illustrates the contribution of each module to tiny object localization and response enhancement.

![Visualization of GPS and SRC ablation](Fig/fig.cro.abla3.png)
